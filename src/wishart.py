...
#                         power1 = np.where(my_clusters[:, 0] != 0, np.power(my_clusters[:, 0], -dim), np.inf)
#                         power2 = np.where(my_clusters[:, 1] != 0, np.power(my_clusters[:, 1], -dim), np.inf)
#                         significan = power1 - power2
